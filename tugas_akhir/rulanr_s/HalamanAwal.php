...
<div class="content-wrapper">
  <div class="container">
    ...
    <section class="content-header">
      <strong>
        <h1>APLIKASI JUAL BELI ONLINE | RULANR STORE INDONESIA </h1>
      </strong>
      <ol class="breadcrumb">
        ...
        <div class="col-md-8">
          ...
          <div class="box box-primary">
            <div class="box-body">
              ...
              <h2 class="page-header">SILAHKAN PILIH BARANG YANG AKAN ANDA BELI</h2>
                              ...
                              <div class="col-sm-8 border-right">
                                <div class="description-block">
                                  <h6 class="description-header"><?php echo "Rp. " . number_format("$r[harga]", '0', '.', '.') . " " ?>
                                    ...
                                    <input type="hidden" name="id_har ga" value="<?php echo $r['id_harga'] ?>">
