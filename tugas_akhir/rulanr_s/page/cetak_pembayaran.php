...
<table border='0' align='LEFT'>
    <tr>
        ...
        <th width="900px" align="left">
            <h2>
                <left> LAPORAN PEMBAYARAN RULANR STORE INDONESIA<br> </left>
...
<br>
<h3 style="text-align:center;"> LAPORAN PEMBAYARAN RULANR STORE INDONESIA </h3>
...
<table border='0' align='right'>
    <tr>
        ...
        <th><?php
            ...
            ?>
            <p style="margin: 50px 8px 5px 420px;"> INDONESIA, <?php echo "$tanggal" ?>
                <h4>
                    <center> </center>
                </h4>
                <br>
