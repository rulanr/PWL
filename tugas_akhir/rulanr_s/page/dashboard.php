              ...
              <div class="row">
                <div class="col-lg-3 col-xs-6">
                  ...
                  <div class="small-box bg-aqua">
                    ...
                    <a href="?pg=menu&act=view" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                  </div>
                </div><!-- ./col -->
                <div class="col-lg-3 col-xs-6">
                  <?php
                  ...
                  <div class="small-box bg-green">
                    ...
                    <a href="?pg=pmsn&act=view" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                  </div>
                </div><!-- ./col -->
                <div class="col-lg-3 col-xs-6">
                  <?php
      ...
      <div class="row">
        ...
        <section class="col-md-12 connectedSortable">
          <div class="callout callout-danger" style="background-color: #red !important;">
            ...
            <p>DI APLIKASI JUAL BELI ONLINE | RULANR STORE INDONESIA</p>
          </div>
