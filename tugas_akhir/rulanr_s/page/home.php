...
<head>
  ...
  <title>APLIKASI JUAL BELI ONLINE| RULANR STORE INDONESIA</title>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
            <ul class="nav navbar-nav">
              <li class="active"><a href="/"> RULANR STORE INDONESIA <span class="sr-only">(current)</span></a></li>
              <!-- <li><a href="#">Link</a></li> -->
              <?php
              ...
              ?>
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="?pg=kategori&act=view">Daftar Kategori produk</a></li>
                    <li class="divider"></li>
                    <li><a href="?pg=menu&act=view">Daftar produk</a></li>
                    <li class="divider"></li>
                    <li><a href="?pg=hrg&act=view">Daftar Harga</a></li>
                    <li class="divider"></li>
                    <li><a href="?pg=stok&act=view">Daftar Stok produk</a></li>
                    <li class="divider"></li>
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="?pg=pmsn&act=view"><i class="fa fa-check-square-o"></i> Transaksi Pemesanan produk</a></li>
                    <li class="divider"></li>
                    <li><a href="?pg=pmby&act=view"><i class="fa fa-check-square-o"></i> Transaksi Pembayaran produk</a></li>
                    <li class="divider"></li>
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li class="divider"></li>
                    <li><a href="?pg=lap_pemesanan&act=view"><i class="fa fa-check-square-o"></i> Laporan Pesanan</a></li>
                    <li class="divider"></li>
              ...
              ?>
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown">Data Transaksi <span class="caret"></span></a>
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="?pg=pmsn&act=view"><i class="fa fa-check-square-o"></i> Transaksi Pesanan</a></li>
                    <li class="divider"></li>
                    <li><a href="?pg=pmby&act=view"><i class="fa fa-check-square-o"></i> Transaksi Pembayaran </a></li>
                    <li class="divider"></li>
                  </ul>
                </li>
              <?php } ?>
